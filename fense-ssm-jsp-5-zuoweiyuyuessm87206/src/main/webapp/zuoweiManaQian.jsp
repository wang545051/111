...
<div class="gywst">
    ...
    <div class="gywstnr">
        ...
        类别:
        <select style="border:solid 1px #000000; color:#666666;" name="leibieid" id="leibieid">
        ...
        楼层:
        <select style="border:solid 1px #000000; color:#666666;" name="loucengid" id="loucengid">
            <option value="">全部</option>
        ...
        房间:
        <select style="border:solid 1px #000000; color:#666666;" name="fangjianid" id="fangjianid">
            <option value="">全部</option>
...
<%--                <td width="40px" align="center" bgcolor="">序号</td>--%>
        ...
        <td bgcolor='' align="center">楼层</td>
        <td bgcolor='' align="center">房间</td>
        <td bgcolor='' align="center">是否空闲</td>
        <td bgcolor='' align="center">环境图片</td>
