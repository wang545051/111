...
<head>
    ...
    <script language="javascript">
        ...
        //跳转到子表zuowei添加页面
        function loucengzuoweiAddQian(id) {
            var url="${contextPath}/loucengzuoweiAddQian/"+id;
            window.location.href=url;
        }
        //跳转到子表zuowei查看页面
        function loucengzuoweiGetByloucengidQian(id) {
            var url="${contextPath}/loucengzuoweiGetByloucengidQian/"+id;
            window.location.href=url;
        }
    ...
    <tr>
        ...
        <td width="39%">
            ...
            <tr>
                <td>&nbsp;</td>
                <td colspan="3">
                <input type="button" value="座位添加" onclick="loucengzuoweiAddQian(${louceng.id})"/>
                <input type="button" value="座位查看" onclick="loucengzuoweiGetByloucengidQian(${louceng.id})"/>
