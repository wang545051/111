...
<head>
    ...
    <script type="text/javascript">
        //导出信息
        function daochu() {
            var url = "${contextPath}/zuoweiMana?d=1";
...
<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px"
       bordercolor="#008080">
    <form action="${contextPath}/zuoweiMana" name="formSearch" id="formSearch" method="post">
    ...
    <tr bgcolor="#E7E7E7">
        <td height="14" colspan="100" background="${staticPath}/images/tbg.gif">座位管理</td>
    </tr>
    ...
    <c:forEach items="${pageInfo.records}" var="info" varStatus="s">
        <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';"
            ...
            <c:choose>
                ...
                <input type="button" value="审核" onclick="zuoweiSet(${info.id},'shenhe','yes')"/>
                </c:when>
                <c:otherwise>
                <input type="button" value="取消" onclick="zuoweiSet(${info.id},'shenhe','no')"/>
                </c:otherwise>
            </c:choose>
