...
<form name="formAdd" id="formAdd">
    <table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC"
        ...
        <tr bgcolor="#EEF4EA">
            <td colspan="3" background="${staticPath}/img/wbg.gif" class='title'><span>&nbsp;留言反馈修改</span>
            </td>
        </tr>
		...
		<tr align='center' bgcolor="#FFFFFF" height="22">
            ...
            <td width="90%" bgcolor="#FFFFFF" align="left">
                <input type="text" name="liuyanshijian" id="liuyanshijian" style="border:1px solid #cccccc;" readonly="readonly" size="20px" value="${liuyan.liuyanshijian}" />
            </td>
