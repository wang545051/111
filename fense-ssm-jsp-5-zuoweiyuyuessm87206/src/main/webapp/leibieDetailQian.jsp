...
<head>
    ...
    <script language="javascript">
        ...
        //跳转到子表zuowei添加页面
        function leibiezuoweiAddQian(id) {
            var url="${contextPath}/leibiezuoweiAddQian/"+id;
            window.location.href=url;
        }
        //跳转到子表zuowei查看页面
        function leibiezuoweiGetByleibieidQian(id) {
            var url="${contextPath}/leibiezuoweiGetByleibieidQian/"+id;
            window.location.href=url;
        }
    ...
    <tr>
        ...
        <td width="39%">
            ...
            <tr>
                <td>&nbsp;</td>
                <td colspan="3">
                <%--<input type="button" value="座位添加" onclick="leibiezuoweiAddQian(${leibie.id})"/>--%>
                <input type="button" value="座位查看" onclick="leibiezuoweiGetByleibieidQian(${leibie.id})"/>
