...
<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC"
    ...
    <tr bgcolor="#EEF4EA">
        <td colspan="3" background="${staticPath}/img/wbg.gif" class='title'><span>&nbsp;房间详情</span>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td width="90%" bgcolor="#FFFFFF" align="left">
                <%--<input type="button" value="座位添加" onclick="fangjianzuoweiAdd(${fangjian.id})"/>--%>
                <%--<input type="button" value="座位查看" onclick="fangjianzuoweiGetByfangjianid(${fangjian.id})"/>--%>
