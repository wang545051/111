...
<div class="gywst">
    ...
    <div class="gywstnr">
        ...
        时间段:<input type="text" style='border:solid 1px #000000; color:#666666' name="jianduan" id="jianduan" size="12px" value="${req.jianduan}"/>&nbsp;&nbsp;
...
<%--                <td width="40px" align="center" bgcolor="">序号</td>--%>
        <td bgcolor='' align="center">时间段</td>
...
<%--                    </td>--%>
            <td bgcolor="" align="center">
                <c:choose>
                    ...
                    <td width="40px" align="center">
                        <a href="${contextPath}/shiduanDetailQian/${info.id}">
                            详细
                        </a>
                    </td>
                </tr>
