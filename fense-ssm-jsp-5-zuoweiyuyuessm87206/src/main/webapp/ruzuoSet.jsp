        ...
        function ruzuoSet() {
            ...
            $.ajax({
                ...
                success: function (resp) {
                    if (resp.success) {
                        alert("修改成功！");
                        //window.location.href = "${contextPath}/ruzuoMana";
                    } else {
                        alert(resp.message);
                    }
                }
...
<form name="formAdd" id="formAdd">
    <table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC"
        ...
        <tr bgcolor="#EEF4EA">
            <td colspan="3" background="${staticPath}/img/wbg.gif" class='title'><span>&nbsp;入座修改</span>
            </td>
        </tr>
		<tr align='center' bgcolor="#FFFFFF" height="22">
            ...
            <td width="90%" bgcolor="#FFFFFF" align="left">
                <input type="text" name="xingming" id="xingming" value="${ruzuo.xingming }" size="90px"/>
            </td>
		...
		<tr align='center' bgcolor="#FFFFFF" height="22">
            ...
            <td width="90%" bgcolor="#FFFFFF" align="left">
                <input type="text" name="dianhua" id="dianhua" value="${ruzuo.dianhua }" size="90px"/>
            </td>
		...
		<tr align='center' bgcolor="#FFFFFF" height="22">
            ...
            <td width="90%" bgcolor="#FFFFFF" align="left">
                <select name="zuoweiid" id="zuoweiid" style="  border:solid 1px #000000; color:#666666">
                    <option value="${ruzuo.zuowei.id }">${ruzuo.zuowei.bianhao }</option>
                </select>
            </td>
            <script type="text/javascript">
		...
		<tr align='center' bgcolor="#FFFFFF" height="22">
            ...
            <td width="90%" bgcolor="#FFFFFF" align="left">
                <input type="text" name="shijian" id="shijian" style="border:1px solid #cccccc;" readonly="readonly" size="20px" value="${ruzuo.shijian}" />
            </td>
		...
		<tr align='center' bgcolor="#FFFFFF" height="22">
            ...
            <td width="90%" bgcolor="#FFFFFF" align="left">
                <input type="text" name="beizhu" id="beizhu" value="${ruzuo.beizhu }" size="90px"/>
            </td>
		...
		<tr align='center' bgcolor="#FFFFFF" height="22">
            ...
            <td width="90%" bgcolor="#FFFFFF" align="left">
                <select name="usersslid" id="usersslid" style="  border:solid 1px #000000; color:#666666">
                    <option value="${ruzuo.users.id }">${ruzuo.users.loginname }</option>
                </select>
            </td>
            <script type="text/javascript">
        ...
        <tr align='center' bgcolor="#FFFFFF" height="22">
            ...
            <td width="90%" bgcolor="#FFFFFF" align="left">
                <input type="hidden" id="id" name="id" value="${ruzuo.id}"/>
                <input type="button" value="提交" onclick="ruzuoSet();"/>&nbsp;
