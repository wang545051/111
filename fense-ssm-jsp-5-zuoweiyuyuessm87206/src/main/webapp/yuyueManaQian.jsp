...
<div class="gywst">
    ...
    <div class="gywstnr">
        ...
        座位:
        <select style="border:solid 1px #000000; color:#666666;" name="zuoweiid" id="zuoweiid">
        ...
        时段:
        <select style="border:solid 1px #000000; color:#666666;" name="shiduanid" id="shiduanid">
            <option value="">全部</option>
...
<%--                <td width="40px" align="center" bgcolor="">序号</td>--%>
        ...
        <td bgcolor='' align="center">座位</td>
        <td bgcolor='' align="center">时段</td>
        <td bgcolor='' align="center">日期</td>
...
<%--                    </td>--%>
            ...
            <td bgcolor="" align="center">
                <c:choose>
                    ...
                    <td width="40px" align="center">
                        <a href="${contextPath}/yuyueDetailQian/${info.id}">
                            详细
                        </a>
                    </td>
                </tr>
